...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Amariel Kaleb : ","color":"green","extra":[{"text":"Welcome to the Kortaek Inn. If you want to rest in one of our rooms, rent one for the day for an honest price.","color":"dark_aqua"}]}
