...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Gerard : ","color":"green","extra":[{"text":"If I came to live in Earndhel it was precisely for its peaceful and quiet side. Now strangers are flocking through this evil portal and you are the cause... I don't want to see you in my house anymore! Go travel elsewhere!","color":"dark_aqua"}]}
