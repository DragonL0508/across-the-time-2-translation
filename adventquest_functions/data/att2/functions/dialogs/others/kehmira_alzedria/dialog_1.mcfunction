...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Kehmira Alzedria : ","color":"green","extra":[{"text":"Hello, do you want to buy one of my delicious fruits?","color":"dark_aqua","extra":[{"text":" [See the merchandise -->]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/shop/seller/kehmira_alzedria_shop_opening"},"hoverEvent":{"action":"show_text","value":"Click here to look at what Kehmira is selling."}}]}]}
