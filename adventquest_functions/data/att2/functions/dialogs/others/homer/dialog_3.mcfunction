...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Homer : ","color":"green","extra":[{"text":"Hey, is it you who opened the passage to the center of the island? I snuck into the dungeon and found lots of treasure including this armor allowing you to swim quickly and breathe longer underwater... Interested?","color":"dark_aqua","extra":[{"text":" [See the merchandise -->]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/shop/seller/homer_shop_opening"},"hoverEvent":{"action":"show_text","value":"Click here to look at what Homer is selling."}}]}]}
