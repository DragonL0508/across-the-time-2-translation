...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Chris Amork : ","color":"green","extra":[{"text":"Hey you! I was about to go to the market to sell my horses, but my trailer dropped... Now it is too late, and I missed a golden opportunity to do very good business... At least I thought...? By any chance, aren't you interested in my racing animals?!","color":"dark_aqua","extra":[{"text":" [See the merchandise -->]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/shop/seller/chris_amork_shop_opening"},"hoverEvent":{"action":"show_text","value":"Click here to look at what Chris is selling."}}]}]}
