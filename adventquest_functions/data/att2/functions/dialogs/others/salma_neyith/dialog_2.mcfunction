...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Salma Neyith : ","color":"green","extra":[{"text":"Yes? Would you like to rent a room? I'll make it 20 Chronotons the night.","color":"dark_aqua"}]}
