...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Elziel Salvidam : ","color":"green","extra":[{"text":"Hello! Are you interested in my clothes imbued with Dahäl enchantments? I sell all kinds.","color":"dark_aqua","extra":[{"text":" [See the merchandise -->]","color":"yellow","clickEvent":{"action":"run_command","value":"/function att2:gameplay/shop/seller/elziel_salvidam_shop_opening"},"hoverEvent":{"action":"show_text","value":"Click here to look at what Elziel is selling."}}]}]}
