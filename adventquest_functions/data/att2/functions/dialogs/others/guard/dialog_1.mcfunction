...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Guardian : ","color":"green","extra":[{"text":"You can't get through! My mission is to watch the area, we have fenced the area because monsters were coming from this passage!","color":"dark_aqua"}]}
