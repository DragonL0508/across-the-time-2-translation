...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Gaëlle : ","color":"green","extra":[{"text":"Welcome to the Kortaek bank, you can safely deposit your money and of course you can withdraw it at any time here. Click on the panels to proceed with the transfers.","color":"dark_aqua"}]}
