...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"Very well, let me explain... Have you ever been in contact with the magic source known as 'Corruption'?","color":"yellow","italic":true}]}
