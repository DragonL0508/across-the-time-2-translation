...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"I'm sorry... No one deliberately sends a friend towards corruption... Maybe you consider him as your ally, but I think he has manipulated you like his pawn and he doesn't share your respect for him.","color":"yellow","italic":true}]}
