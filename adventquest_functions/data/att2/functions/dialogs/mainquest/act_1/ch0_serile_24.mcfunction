...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"Let me ask you a couple questions: did you use the power of corruption because of your own free will, or did someone force you to use it?","color":"yellow","italic":true}]}
