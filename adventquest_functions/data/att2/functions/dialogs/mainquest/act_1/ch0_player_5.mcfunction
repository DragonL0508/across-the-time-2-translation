...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Ok now I need to go back to the mall to take this plastic flower to the florist...","color":"aqua"}]}
