...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"What time is it? Oh, I thought I had delivered this important letter to the courthouse. Well, now that I'm awake, I won't be able to go back to sleep. I need to bring this letter...","color":"aqua"}]}
