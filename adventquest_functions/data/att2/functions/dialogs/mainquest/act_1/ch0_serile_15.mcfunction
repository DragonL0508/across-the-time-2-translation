...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"There's the second one. The last one should be on the top floor of the building, I'll open the way for you...","color":"yellow","italic":true}]}
