...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"I'll send you back to the past, four years after your journey. I'm sorry, I can't come with you. You'll need to find Etotsira on your own...","color":"yellow","italic":true}]}
