...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"I see. That's a good thing ! Otherwise, the only way out would have been death... Anyways, who forced you, or should I say ''guided'' you towards the source of corrupton?","color":"yellow","italic":true}]}
