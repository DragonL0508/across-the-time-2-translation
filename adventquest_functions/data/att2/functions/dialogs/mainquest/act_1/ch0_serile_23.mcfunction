...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"There we go, your life expectancy has lengthened. Congrats. But you're still not out of it.","color":"yellow","italic":true}]}
