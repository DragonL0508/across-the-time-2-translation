...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"Here's the first display case, shatter it to pieces. A simple fireball should do the job...","color":"yellow","italic":true}]}
