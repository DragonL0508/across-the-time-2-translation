...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"Everyone who has once tasted it have fallen under the hold of its power...","color":"yellow","italic":true}]}
