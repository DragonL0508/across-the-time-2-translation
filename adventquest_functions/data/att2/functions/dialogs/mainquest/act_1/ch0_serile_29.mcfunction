...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"You need to find this man, and kill him... That way, you'll be able to change your destiny and get rid of this curse.","color":"yellow","italic":true}]}
