...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"Aren't you the hero of Tellurön written down in the legends? Anyways, if you don't trust me, I won't be able to help you!","color":"yellow","italic":true}]}
