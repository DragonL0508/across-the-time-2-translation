...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Phew, it's over... this situation cannot last any longer! 'S' if you can hear me...","color":"aqua"}]}
