...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"We are now safe... I know the cause of your pain and I want to help you. You can call me S...","color":"yellow","italic":true}]}
