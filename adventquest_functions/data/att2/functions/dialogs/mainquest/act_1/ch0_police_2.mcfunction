...
tellraw @a[scores={LANGUAGE=2}] {"text":"(-)=(-) Police : ","color":"gray","extra":[{"text":"THE PARLIAMENT IS SURROUNDED!! YOU CANNOT ESCAPE..! EXIT THE BUILDING AND PUT YOUR HANDS IN THE AIR!!","color":"dark_red"}]}
