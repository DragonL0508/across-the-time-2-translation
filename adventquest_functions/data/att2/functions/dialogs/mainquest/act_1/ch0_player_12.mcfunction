...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I can't kill them without a weapon, I need to use a Dahäl spell!","color":"aqua"}]}
