...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"All evil has an origin, someone responsible for it... In your case, it's clear to see that person is Etotsira. What I'm about to tell you is not pleasing, are you ready to hear it?","color":"yellow","italic":true}]}
