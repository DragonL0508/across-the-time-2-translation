...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"There's one delivery done. Now I need to take this package and deliver it to the Starmucks Coffee at the train station.","color":"aqua"}]}
