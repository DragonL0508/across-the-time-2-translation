...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"One last thing... He'll try to corrupt you again. Maybe he'll even try to blame it on you, or even on me.","color":"yellow","italic":true}]}
