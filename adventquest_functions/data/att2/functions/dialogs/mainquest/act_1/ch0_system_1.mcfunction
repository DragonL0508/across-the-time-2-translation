...
tellraw @a[scores={LANGUAGE=2}] {"text":"","color":"gray","italic":true,"extra":[{"text":"There's a program on the TV: ... the Lambda company is proud to be able to distribute power to the entire world. Come visit the very first open energy emitting tower ! <Lambda CORP, the future is yours!>","color":"gold","italic":false}]}
