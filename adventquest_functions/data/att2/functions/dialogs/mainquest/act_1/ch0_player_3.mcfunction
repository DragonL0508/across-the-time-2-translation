...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Well then, I have quite a lot to deliver, starting off with these trousers that supposedly belonged to someone famous. I need to bring it back to the H&H store in the shopping mall.","color":"aqua"}]}
