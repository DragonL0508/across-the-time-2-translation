...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° S : ","color":"gray","extra":[{"text":"Don't stay here, the police won't be able to help you. Follow me, or you are doomed...","color":"yellow","italic":true}]}
