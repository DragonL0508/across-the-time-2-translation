...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Azazel : ","color":"gold","extra":[{"text":"Who are you, insignificant mortal, and for what trivial reason do you dare to present yourself before me?...","color":"dark_aqua"}]}
