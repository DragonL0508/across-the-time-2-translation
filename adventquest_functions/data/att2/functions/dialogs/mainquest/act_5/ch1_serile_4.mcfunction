...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Serile : ","color":"gray","extra":[{"text":"You can be the reincarnation of the master of the masters if you want, but you won't stop me from fulfilling my destiny. Because you are mortal now, and I have already beaten you.","color":"yellow","italic":true}]}
