...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I know that you're wrong, and that you're afraid of me. You wouldn't have sent me to a certain death if you hadn't to.","color":"aqua"}]}
