...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Serile : ","color":"gray","extra":[{"text":"No! How can you resist me? It cannot be real, Relgon! You'll never stop me from fulfilling my destiny!","color":"yellow","italic":true}]}
