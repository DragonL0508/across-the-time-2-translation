...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"This electricity sphere ! It'll destroy all the electronic devices of the city!","color":"aqua"}]}
