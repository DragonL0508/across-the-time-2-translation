...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Serile : ","color":"gray","extra":[{"text":"Then you know that I've been waiting for millenia for this moment. And that now, nothing can't stop me.","color":"yellow","italic":true}]}
