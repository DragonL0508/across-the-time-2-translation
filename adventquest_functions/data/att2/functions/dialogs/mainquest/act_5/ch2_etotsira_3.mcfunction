...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"You'll have understood it : by destruction, no heroes arise. By saving her, you also save yourself...","color":"dark_aqua"}]}
