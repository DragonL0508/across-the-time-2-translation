...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I faced him, in the past, without being able to beat him because he's an immortal... But he still reigns on Angband!","color":"aqua"}]}
