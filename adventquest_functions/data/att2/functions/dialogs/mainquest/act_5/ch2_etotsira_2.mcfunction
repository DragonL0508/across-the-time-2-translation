...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"Returning in Angband, she'll restore the order that has been lost for a long time...","color":"dark_aqua"}]}
