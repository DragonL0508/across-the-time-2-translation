...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Greetings. Wirth Razgork, a friend of Indra's, sent me to meet her. I...","color":"aqua"}]}
