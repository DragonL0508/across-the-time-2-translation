...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Ragnar Lorth : ","color":"green","extra":[{"text":"You're an adventurer, I guess? Look, she's not as young as you are, and I think you should leave her out of your stories.","color":"dark_aqua"}]}
