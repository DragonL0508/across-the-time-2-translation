...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sylvandre : ","color":"green","extra":[{"text":"So many things have changed during these four years, I think you should have a look around town! Follow me!","color":"dark_aqua"}]}
