...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Hello, you're Indra, I think? I am a friend of Wirth's, he sent me to you to help me in my search for an object... unusual.","color":"aqua"}]}
