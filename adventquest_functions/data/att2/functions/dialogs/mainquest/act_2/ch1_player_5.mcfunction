...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I'm exhausted, I come from afar. I was just looking for a place to stay...","color":"aqua"}]}
