...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Gonon : ","color":"green","extra":[{"text":"I can rent you a room for the night for the small price of 25 Chronotons!","color":"dark_aqua"}]}
