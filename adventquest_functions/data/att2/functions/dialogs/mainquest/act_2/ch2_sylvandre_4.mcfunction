...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sylvandre : ","color":"green","extra":[{"text":"Of course! (Follow my lead!) How are you? How long has it been since we last saw each other?","color":"dark_aqua"}]}
