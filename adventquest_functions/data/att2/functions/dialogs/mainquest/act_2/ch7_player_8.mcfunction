...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I can now access this arena in the center of the island, I hope to finally find a big key...","color":"aqua"}]}
