...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The road is collapsed.... This tree seems ready to fall, a fireball at its base should cause it to collapse.","color":"aqua"}]}
