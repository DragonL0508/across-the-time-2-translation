...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Gonon : ","color":"green","extra":[{"text":"A warrior who is a master of Dahäl! Those don't grow on trees! Today's my lucky day!... or night...","color":"dark_aqua"}]}
