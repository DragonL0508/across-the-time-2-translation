...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Brrr... It's cold here... I feel exhausted. She could've sent me directly inside of a city or something...","color":"aqua"}]}
