...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sylvandre : ","color":"green","extra":[{"text":"If you wish, the master can reset your skill points... I mean, uh, when you want to reorient your aptitude...","color":"dark_aqua"}]}
