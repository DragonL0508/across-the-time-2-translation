...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"This island is vast and in ruins by the way, exploration will be difficult. Let's start with the places that can be walked, I'll have to go around to reach the other side...","color":"aqua"}]}
