...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Yaakov Rav : ","color":"green","extra":[{"text":"Yes, there is a way to activate it. You need 3 fragments of stones called: ''Gem of Space''. Unfortunately, they are scattered all over the world.","color":"dark_aqua"}]}
