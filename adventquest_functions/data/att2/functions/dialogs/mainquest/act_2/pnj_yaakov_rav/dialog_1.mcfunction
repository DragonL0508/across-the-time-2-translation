...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Yaakov Rav : ","color":"green","extra":[{"text":"Welcome to my humble home, stranger.... If you are interested in Dahäl, I sell all kinds of incantation books. So, how can I help you?","color":"dark_aqua"}]}
