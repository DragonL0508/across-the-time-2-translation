...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Indra Lorth : ","color":"green","extra":[{"text":"Oh...A friend of Wirth's, you say? Surprising that this mulehead still has some? But coming from a novice like him, it doesn't surprise me that he sent you to me! So, what is this object you're looking for?","color":"dark_aqua"}]}
