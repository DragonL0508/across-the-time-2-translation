...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sylvandre : ","color":"green","extra":[{"text":"Me! Selfish? I don't think that's correct! I spend my time helping the people!","color":"dark_aqua"}]}
