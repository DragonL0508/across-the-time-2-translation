...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"It has to stop. What will happen if I have a seizure in the middle of a city...","color":"aqua"}]}
