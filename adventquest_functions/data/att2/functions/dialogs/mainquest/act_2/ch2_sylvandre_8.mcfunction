...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sylvandre : ","color":"green","extra":[{"text":"This is the seamstress's house, she's been gifted with Dahäl. She can sell you enchanted clothing.","color":"dark_aqua"}]}
