...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"It is probably from this place that the main door of the temple opens. I need these turquoise stones to activate the mechanism. There should be some in the area....","color":"aqua"}]}
