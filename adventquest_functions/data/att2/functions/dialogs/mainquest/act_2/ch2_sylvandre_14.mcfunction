...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sylvandre : ","color":"green","extra":[{"text":"We're now in front of the inn. Here you'll be able to rent a room to store some of your stuff and rest.","color":"dark_aqua"}]}
