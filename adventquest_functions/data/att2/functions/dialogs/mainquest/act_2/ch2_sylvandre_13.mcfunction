...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sylvandre : ","color":"green","extra":[{"text":"*Clears throat* This area has a bad reputation, there's a shady shop that'll buy weapons you don't use anymore. Apparently, they also sell some special items...","color":"dark_aqua"}]}
