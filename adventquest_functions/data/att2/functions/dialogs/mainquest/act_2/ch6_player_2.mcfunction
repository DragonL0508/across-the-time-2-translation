...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Yes, I found the temple in the marshes and then the gem it contained. Now, do you know where I could find a second one?","color":"aqua"}]}
