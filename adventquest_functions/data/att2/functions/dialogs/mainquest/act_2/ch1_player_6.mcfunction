...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I don't have a dime... But I can't go back outside. Would you allow me to stay here for the night, and then I can pay you back later?","color":"aqua"}]}
