...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"This must be the structure Indra told me about.... Three locks, so I need three keys, maybe in the towers....","color":"aqua"}]}
