...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I must be in Méleïm. I have to find Ragnar now, his house should be on top of a rocky peak....","color":"aqua"}]}
