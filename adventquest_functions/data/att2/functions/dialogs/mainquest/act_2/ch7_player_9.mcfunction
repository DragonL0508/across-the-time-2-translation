...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"But of course, I understood! To access the gem you have to flood the large room. There are doors that have opened at the four corners, I will be able to access these large pillars to perhaps activate the opening of the hatches up there.","color":"aqua"}]}
