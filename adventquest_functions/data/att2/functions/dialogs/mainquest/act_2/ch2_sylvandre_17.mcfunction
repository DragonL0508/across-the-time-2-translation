...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sylvandre : ","color":"green","extra":[{"text":"The palace is the biggest pride of our city. It can endure a siege of over two years! It's the home of our king, his queen and his daughter the young princess. Only a couple of privileged people are allowed to enter...","color":"dark_aqua"}]}
