...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Gonon : ","color":"green","extra":[{"text":"Sorry, we don't do credit here... You know, we're not as wealthy as the people in Ryliath, the neighbouring city... Furthermore, I don't trust you enough. I'm going to have to ask you to leave.","color":"dark_aqua"}]}
