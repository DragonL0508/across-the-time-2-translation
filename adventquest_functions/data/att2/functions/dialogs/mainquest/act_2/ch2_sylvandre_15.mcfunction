...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sylvandre : ","color":"green","extra":[{"text":"The master of Dahäl will buy and sell books of incantation. It's quite a little frequented shop, but it's such an intriguing one! I'd love to master this art.","color":"dark_aqua"}]}
