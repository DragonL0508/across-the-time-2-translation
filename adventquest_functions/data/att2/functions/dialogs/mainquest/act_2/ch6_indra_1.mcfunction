...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Indra Lorth : ","color":"green","extra":[{"text":"Oh..... Look who's back, it's our budding gem finder! So, did you find what you were interested in?","color":"dark_aqua"}]}
