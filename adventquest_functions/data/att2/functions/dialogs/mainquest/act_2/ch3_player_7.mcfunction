...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"It's a gem of space! All I have to do now is take it back to Ryliath!","color":"aqua","italic":true}]}
