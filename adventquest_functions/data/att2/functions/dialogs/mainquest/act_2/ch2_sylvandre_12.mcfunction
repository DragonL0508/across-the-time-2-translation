...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sylvandre : ","color":"green","extra":[{"text":"Here is one of my favorite shops : At the alchemist's you'll find all kinds of potions and enchanted arrows!","color":"dark_aqua"}]}
