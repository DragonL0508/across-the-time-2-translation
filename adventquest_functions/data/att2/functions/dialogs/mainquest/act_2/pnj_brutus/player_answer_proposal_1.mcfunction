...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Hit, hit, hit and hit again! I'm just trying to get into the temple! -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-009a-0000-00000000009a if entity @s[distance=..7] if score brutus_PNJ DIALOG matches 1 run function att2:dialogs/mainquest/act_2/pnj_brutus/answer_green_1"},"hoverEvent":{"action":"show_text","value":"Click here - answer 1"}}]}
