...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Estelle : ","color":"green","extra":[{"text":"For sure, I'd have fun, but with an irresponsible and selfish waiter, I doubt it...","color":"dark_aqua"}]}
