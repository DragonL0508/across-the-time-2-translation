...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"This tower does not seem to have access.... However, it is connected by a bridge at its top to the other tower. There must be an entrance for this one.","color":"aqua"}]}
