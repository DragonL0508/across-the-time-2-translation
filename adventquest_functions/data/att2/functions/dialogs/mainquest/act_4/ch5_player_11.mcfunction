...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"What's this... weird place?! I can see a portal into the next room, I need to find my way out of here.","color":"aqua"}]}
