...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Lucas : ","color":"green","extra":[{"text":"Sorry, but I can't give you one. I can make you new ones, but the wind will have the time to switch a thousand times of way before my task ends.","color":"dark_aqua"}]}
