...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Skaolon : ","color":"green","extra":[{"text":"So what? Warriors are respectable people, but nothing's too good for our revered excellence.","color":"dark_aqua"}]}
