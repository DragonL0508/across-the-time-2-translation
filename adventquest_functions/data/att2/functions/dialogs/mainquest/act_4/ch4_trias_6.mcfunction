...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Trias : ","color":"green","extra":[{"text":"Exactly and it's very insightful of you. But if you find this bow in other hands, other hands not ready to give it to you, I would like you to bring me his description.","color":"dark_aqua"}]}
