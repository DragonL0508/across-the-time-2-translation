...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Aramis : ","color":"green","extra":[{"text":"I have no doubt about your value in battle or in Dahäl. But everything comes at a price, so if you want to have this information, you'll have to do our city a favour first.","color":"dark_aqua"}]}
