...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Aramis : ","color":"green","extra":[{"text":"I know who you are... I'm not as generous as Etotsira, you see. Our city is starving, so if you are willing to help us, I will also make an effort.","color":"dark_aqua"}]}
