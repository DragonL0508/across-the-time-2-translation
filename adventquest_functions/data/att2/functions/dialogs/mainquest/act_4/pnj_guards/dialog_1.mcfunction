...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Guards : ","color":"green","extra":[{"text":"Solomba stranger! Stay where you are ! Strangers, forbidden on our land, solomba! You follow me to our chief now.","color":"dark_aqua"}]}
