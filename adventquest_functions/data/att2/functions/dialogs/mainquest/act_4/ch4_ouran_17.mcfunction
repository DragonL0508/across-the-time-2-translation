...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Ouran : ","color":"gold","extra":[{"text":"Mother! The disrespectful and mean stranger robbed me, and he tries again to hurt me!","color":"dark_aqua"}]}
