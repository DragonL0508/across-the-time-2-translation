...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"An upgrade to my spells, great ! Let's try this on the ice over there, I have a feeling it won't resist to this.","color":"aqua"}]}
