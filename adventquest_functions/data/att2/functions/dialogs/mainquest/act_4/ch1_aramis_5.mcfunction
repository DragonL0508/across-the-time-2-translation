...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Aramis : ","color":"green","extra":[{"text":"Necromancy is an ancient art whose origins were lost... Unfortunately, it knows no master, and as such it still persists in Sylberländ, there is nothing we can to do wipe it out. Wait, since you offered us your help, I will grant you a new ability for you storage spell. There we go. Good luck...","color":"dark_aqua"}]}
