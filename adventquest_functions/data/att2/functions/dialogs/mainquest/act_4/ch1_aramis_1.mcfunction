...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Aramis : ","color":"green","extra":[{"text":"The gem you are looking for.... What is it? Another attack.... Bring your help to the west gate and then we'll continue this conversation.","color":"dark_aqua"}]}
