...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Perfect, Pelzions are mine! I can now glide wherever I want to thanks to this tool. Let's try them to exit this tower first...","color":"aqua"}]}
