...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The portal of your city, I know that it also allows the passage to other times. I have no choice but to use this one, because the place where I come from cannot be reached by any horse or boat.","color":"aqua"}]}
