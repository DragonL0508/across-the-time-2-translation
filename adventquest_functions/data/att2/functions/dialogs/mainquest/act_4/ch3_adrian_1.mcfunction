...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° King Adrian : ","color":"gold","extra":[{"text":"Well, if it isn't Tellurön's hero here. I heard that you snatched a gem from the claws of the icy Vonaheim ! Incredible, you really own your title !","color":"dark_aqua"}]}
