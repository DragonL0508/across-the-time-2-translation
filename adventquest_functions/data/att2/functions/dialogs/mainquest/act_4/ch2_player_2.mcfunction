...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The air flow has been stopped. I would rather have had it carry me all the way up the tower, but this is a good start... Now, let's go down in the vent, to see if there's anything interesting on the other side.","color":"aqua"}]}
