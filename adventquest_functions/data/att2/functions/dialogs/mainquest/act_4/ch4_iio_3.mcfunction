...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Iio : ","color":"yellow","extra":[{"text":"There's nothing that you owe that he can really steal. Because your valor remains in your heart of gold and not in your material properties","color":"dark_aqua"}]}
