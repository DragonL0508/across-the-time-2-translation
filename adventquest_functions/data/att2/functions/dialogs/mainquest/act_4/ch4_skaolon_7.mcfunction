...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Skaolon : ","color":"green","extra":[{"text":"You? A hero? Ahahahaha, no. Well, since you're funny, I'll make you a deal : our exquisite king loves the refined foodstuff that's the Neleptrons. Bring us some and maybe we'll let you in.","color":"dark_aqua"}]}
