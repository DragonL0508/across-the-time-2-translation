...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Thanks to their own weight, these golems allow the elevator to descend. They must not die otherwise I would risk getting stuck...","color":"aqua"}]}
