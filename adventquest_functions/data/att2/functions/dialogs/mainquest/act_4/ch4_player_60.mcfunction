...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"It was amazing... Iio, She has to be this kingdom's goddess... Well, let's bring this time gem on its receptacle...","color":"aqua"}]}
