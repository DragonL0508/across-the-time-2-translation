...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Take the gem of time. -->]","color":"gold","clickEvent":{"action":"run_command","value":"/function att2:cinematic/act_4/gem_of_time/trigger1"},"hoverEvent":{"action":"show_text","value":"Click here to take the gem."}}]}
