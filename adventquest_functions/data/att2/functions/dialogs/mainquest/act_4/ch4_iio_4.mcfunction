...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Iio : ","color":"yellow","extra":[{"text":"Come on, my sweet child, now that he won your game, give him what he came for.","color":"dark_aqua"}]}
