...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The first mechanism has been triggered. I can now access to the east tower to activate the second one.","color":"aqua"}]}
