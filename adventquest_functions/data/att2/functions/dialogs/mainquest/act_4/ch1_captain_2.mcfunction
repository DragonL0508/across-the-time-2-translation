...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Captain : ","color":"green","extra":[{"text":"Archers in position!..... Set fire to it and stand by and fire at my command!","color":"dark_aqua"}]}
