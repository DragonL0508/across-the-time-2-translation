...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Finally... All of the emeralds are in position ! Let's return onto the top of the main pillar, the gem should be accessible...","color":"aqua"}]}
