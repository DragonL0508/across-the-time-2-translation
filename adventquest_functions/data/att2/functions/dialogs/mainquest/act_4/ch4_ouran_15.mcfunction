...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Ouran : ","color":"gold","extra":[{"text":"Enough! Enough! Enough! How dare you make me like this ! You'll know the real magnitude of my anger and of my power!","color":"dark_aqua"}]}
