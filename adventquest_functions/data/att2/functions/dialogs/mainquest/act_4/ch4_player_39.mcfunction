...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Pff... Where could I find another Neleptron... There's a strange mechanism a little higher, I should probably start with this.","color":"aqua"}]}
