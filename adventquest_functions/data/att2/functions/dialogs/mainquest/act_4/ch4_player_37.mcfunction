...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"What?! Now you'll listen to me little scammer! Let me in you don't want to see that Neleptron stuck in your...","color":"aqua"}]}
