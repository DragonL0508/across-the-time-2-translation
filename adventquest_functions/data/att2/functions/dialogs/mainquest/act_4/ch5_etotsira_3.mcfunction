...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"You shall go through the Kert's desert. Go to the west of Ryliath, where the mountains spit fire and find a way to cross the lava rivers.","color":"dark_aqua"}]}
