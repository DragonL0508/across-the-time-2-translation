...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Golem : ","color":"green","extra":[{"text":"At the end of the path, the sticky stones. Their strength and will, the metal being requires.","color":"dark_aqua"}]}
