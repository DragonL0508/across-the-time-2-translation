...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[I wish to shorten my stay in this kingdom, but I won't leave whitout what I came for. So help me, noble... thing and I will leave at once. -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute if entity @a[x=-871,y=70,z=-641,distance=..10,gamemode=adventure] if score golem_PNJ DIALOG matches 1 run function att2:dialogs/mainquest/act_4/pnj_golem/answer_green_1"},"hoverEvent":{"action":"show_text","value":"Click here - answer 1"}}]}
