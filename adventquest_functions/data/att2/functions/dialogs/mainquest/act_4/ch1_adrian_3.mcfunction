...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° King Adrian : ","color":"gold","extra":[{"text":"Well, we'd be happy to help you. First of all, we really want to hear your story!","color":"dark_aqua"}]}
