...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"There's something stangre with this ice... I'm unable to break it by hitting it. I won't waste my time on it, let's continue our descent...","color":"aqua"}]}
