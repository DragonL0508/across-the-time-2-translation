...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Queen Eldaris : ","color":"gold","extra":[{"text":"We never thought we'd see it in working order before you opened it.","color":"dark_aqua"}]}
