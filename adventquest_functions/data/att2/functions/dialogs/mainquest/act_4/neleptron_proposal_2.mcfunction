...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Take the Neleptron. -->]","color":"gold","clickEvent":{"action":"run_command","value":"/function att2:cinematic/act_4/ouranos/neleptron/trigger2"},"hoverEvent":{"action":"show_text","value":"Click here to take the Neleptron."}}]}
