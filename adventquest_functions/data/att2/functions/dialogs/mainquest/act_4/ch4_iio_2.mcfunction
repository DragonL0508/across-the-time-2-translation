...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Iio : ","color":"yellow","extra":[{"text":"Mean, Don't say that... Didn't you have fun? That's right, he's strong, but you are much more sweet than him.","color":"dark_aqua"}]}
