...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"This necromancer doesn't seem too happy to see me, if he thinks he's impressing me, he's not quite there ! Moreover, by destroying the bridge, this idiot made a breach that reveals a passage in the ruins...","color":"aqua"}]}
