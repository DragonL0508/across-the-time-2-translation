...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Here's the ultimate time gem to place on Ryliath's portal... I'll finally be able to return in my era, and say some words to this Sérile...","color":"aqua"}]}
