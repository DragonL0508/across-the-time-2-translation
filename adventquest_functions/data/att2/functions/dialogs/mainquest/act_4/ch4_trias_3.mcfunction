...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Trias : ","color":"green","extra":[{"text":"Before you leave, humble traveler, will you let me ask you some questions to you?","color":"dark_aqua"}]}
