...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Bob L. : ","color":"green","extra":[{"text":"*Ostentatious, immature* Looks like we need a talented magician here!? AHAHAHAHA, I am BOB LAÏNONNE, the most powerful pyrometer in the whole kingdom of Tellurön!","color":"dark_aqua"}]}
