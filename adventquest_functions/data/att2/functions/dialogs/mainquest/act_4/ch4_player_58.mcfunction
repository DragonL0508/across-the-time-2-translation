...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"He now has a whole swarm that protects him and that follows me ... I must try something to get rid of it! Perhaps by shooting an arrow in this bell will have an effect ...","color":"aqua"}]}
