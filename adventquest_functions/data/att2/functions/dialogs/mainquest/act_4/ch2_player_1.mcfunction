...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"What a powerful wind, I will not be able to enter as long as it is there... I wonder where it will lead me if I stop it or reverse it...","color":"aqua"}]}
