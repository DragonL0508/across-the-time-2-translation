...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[I'm here to help you. What is the situation? -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-095a-0000-00000000095a if entity @s[distance=..7] if score captain_PNJ DIALOG matches 1 run function att2:dialogs/mainquest/act_4/pnj_captain/answer_green_1"},"hoverEvent":{"action":"show_text","value":"Click here - answer 1"}}]}
