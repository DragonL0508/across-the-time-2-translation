...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Alréan : ","color":"gold","extra":[{"text":"Oh, this is not a trivial matter. I regret that I can't help you by myself. but those are the kind of secrets that our king own.","color":"dark_aqua"}]}
