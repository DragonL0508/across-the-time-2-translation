...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Here's another one. Skaolon better get me meet the king, I'm not gonna play his game much longer...","color":"aqua"}]}
