...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Alréan : ","color":"gold","extra":[{"text":"Then you are more special than we were thinking of. You went through the portal nearby, aren't you?","color":"dark_aqua"}]}
