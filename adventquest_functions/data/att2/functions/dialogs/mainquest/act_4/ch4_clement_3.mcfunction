...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Clément : ","color":"green","extra":[{"text":"Eh! You owe a weapon, you must be a warrior! Let me lead you to encounter Alrean, leader and elder of the village. She'll offer you a much better hospitality than me.","color":"dark_aqua"}]}
