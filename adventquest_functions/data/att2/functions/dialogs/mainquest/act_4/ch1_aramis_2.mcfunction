...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Aramis : ","color":"green","extra":[{"text":"You're back again. You're probably wondering what caused this attack? The skeletons you just shot are Vonaheim's henchmen. For, at the end of the path on the other side of the west gate of Eolorion is his home.","color":"dark_aqua"}]}
