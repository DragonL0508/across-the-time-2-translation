...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Guard : ","color":"green","extra":[{"text":"Hey there! Wait a minute! I need to ask you a few questions before I let you pass.","color":"dark_aqua"}]}
