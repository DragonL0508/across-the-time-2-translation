...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Captain : ","color":"green","extra":[{"text":"Well, you can say you know how to deal with these damn monsters. Hahahaha, you're damn good at it! We could use more people like you.","color":"dark_aqua"}]}
