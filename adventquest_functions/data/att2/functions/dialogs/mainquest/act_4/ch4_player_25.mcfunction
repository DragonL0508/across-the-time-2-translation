...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"What a somptuous building. Maybe this is the door Alrean was talking. I have to find out.","color":"aqua"}]}
