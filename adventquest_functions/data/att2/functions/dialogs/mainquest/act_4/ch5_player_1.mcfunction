...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Hello princess, I got a time gem in Ouranos, like you said. Now where can I find another one?","color":"aqua"}]}
