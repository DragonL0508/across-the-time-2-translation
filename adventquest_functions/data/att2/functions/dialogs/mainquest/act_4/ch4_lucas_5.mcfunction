...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Lucas : ","color":"green","extra":[{"text":"I have no doubt, forgive me if I sometimes let myself float in the wind. So, you wish to fly?","color":"dark_aqua"}]}
