...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I sweated blood and water to get you these Neleptrons and... I've heard that his excellence is more generous than anybody in that kingdom and that his splendor was matched only by his gratitude...","color":"aqua"}]}
