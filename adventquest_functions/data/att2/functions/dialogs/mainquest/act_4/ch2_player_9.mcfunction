...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Not any stalactite to drop... This time I think I don't really have a choice. Now I just have to hope the wind will carry me sufficiently to cross.","color":"aqua"}]}
