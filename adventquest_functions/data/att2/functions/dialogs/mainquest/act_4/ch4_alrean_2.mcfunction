...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Alréan : ","color":"gold","extra":[{"text":"Sure, we are not inhabitants from Aspälïn, but it does not make us savages.","color":"dark_aqua"}]}
