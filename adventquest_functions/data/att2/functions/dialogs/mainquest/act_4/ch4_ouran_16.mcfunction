...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Ouran : ","color":"gold","extra":[{"text":"No! That's not the end! You don't have the right to stand up to me you little vermilion! Thief! Blasphemer! You'll receive the punishment you deserve for your outrage!","color":"dark_aqua"}]}
