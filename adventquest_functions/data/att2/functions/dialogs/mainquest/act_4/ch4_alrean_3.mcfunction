...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Alréan : ","color":"gold","extra":[{"text":"Of course not, Oh I think I understand, you come from far away... From a place that cannot be reached by walking or flying.","color":"dark_aqua"}]}
