...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Alréan : ","color":"gold","extra":[{"text":"Yes, because they are ready to sacrifice themselves in order to protect their brothers, sisters, aunts, uncles, nieces and nephews, however far apart...","color":"dark_aqua"}]}
