...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Queen Eldaris : ","color":"gold","extra":[{"text":"Time gems? I have read about these artifacts and it seems to me that they are very dangerous.","color":"dark_aqua"}]}
