...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Ouran : ","color":"gold","extra":[{"text":"Disrespectful, you really don't know the power of a king-demigod! Last time you was just lucky! You shall die!","color":"dark_aqua"}]}
