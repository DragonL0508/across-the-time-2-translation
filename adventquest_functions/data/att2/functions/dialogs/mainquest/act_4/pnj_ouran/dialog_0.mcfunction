...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Ouran : ","color":"gold","extra":[{"text":"Hey I recognize you! You are the bug that dares to challenge me four cycles ago!","color":"dark_aqua"}]}
