...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Ouran : ","color":"gold","extra":[{"text":"You think so ? And for what foolish reason should I forgive the slight that a nobody gave me?","color":"dark_aqua"}]}
