...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Iio : ","color":"yellow","extra":[{"text":"That's my Aoran. So understanding and patient. Among all my childrens, you are definitly my favorite!","color":"dark_aqua"}]}
