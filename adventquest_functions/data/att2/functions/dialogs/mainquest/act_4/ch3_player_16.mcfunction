...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Alright, a second gem of time. Let's take it back to Ryliath.","color":"aqua"}]}
