...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Lucas : ","color":"green","extra":[{"text":"So the warrior from Tellurön requires my breath for his present aspirations...","color":"dark_aqua"}]}
