...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Skaolon : ","color":"green","extra":[{"text":"Go in? Wow wow wow, and in what honor would you have the right to disturb the perfect rest of our splendid and vertuous king?","color":"dark_aqua"}]}
