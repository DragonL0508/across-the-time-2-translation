...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Guard : ","color":"green","extra":[{"text":"You there! By order of the King, I will take you to the palace. Please come with me!","color":"dark_aqua"}]}
