...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"Yes, I have no doubt about your capacities. But I'll help you when you'll be approaching Nojelanth...","color":"dark_aqua"}]}
