...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"*raspy breathing* I have... almost... died... Luckily the time anomaly brought me back to a place I never thought I'd be!","color":"aqua"}]}
