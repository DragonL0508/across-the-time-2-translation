...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Alréan : ","color":"gold","extra":[{"text":"Oh, what a good surprise! A warrior makes us the honnor of his coming in our humble village. Let me offer you one of our comfy clothes...","color":"dark_aqua"}]}
