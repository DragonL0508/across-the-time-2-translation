...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The bridge collapsed, I have to find another way to get through. Let's see where the other path leads.","color":"aqua"}]}
