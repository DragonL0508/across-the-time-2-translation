...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I have to look for three gears to fully reactivate the elevator in the south tower. It will surely take me to an extra floor !","color":"aqua","bold":false}]}
