...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"If I have understood correctly, the adventurer I am looking for is Wirth Razgork. He's Sylvandre's father. If he can help me find these space gems, I'd better go talk to him. His house is located to the east of the city.","color":"aqua","bold":false}]}
