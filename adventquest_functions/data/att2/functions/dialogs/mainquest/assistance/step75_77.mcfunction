...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I have to prepare for the final battle, there may not be any return... I'll just have to tell Relgon at camp when I'm ready to go!","color":"aqua","bold":false}]}
