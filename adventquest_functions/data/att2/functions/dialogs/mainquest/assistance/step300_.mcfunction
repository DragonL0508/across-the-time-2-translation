...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"My quest ends here... However, I can now set about helping the people of Sylberländ, Angband and Ouranos to uncover all the secrets that the realms hold.","color":"aqua","bold":false}]}
