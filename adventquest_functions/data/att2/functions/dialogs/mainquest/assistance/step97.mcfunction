...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The city of Eolorion is attacked. Aramis is counting on me to help the army repel the enemy, I have to go to the big door to the west of the city.","color":"aqua","bold":false}]}
