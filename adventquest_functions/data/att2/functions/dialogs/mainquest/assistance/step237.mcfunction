...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The chest is unlocked. I have to take its contents and as usual find a big key in it to open the main door in the past.","color":"aqua","bold":false}]}
