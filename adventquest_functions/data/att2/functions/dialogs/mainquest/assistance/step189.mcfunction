...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Lucas, the wind artist cannot give me wings to glide, but he indicated to me where I could find them. I have to take the catapult and enter the tower in front of Zirthion.","color":"aqua","bold":false}]}
