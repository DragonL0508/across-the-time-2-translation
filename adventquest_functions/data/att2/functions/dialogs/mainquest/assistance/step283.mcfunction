...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Sérile is determined, I must try to stop it before it destroys the whole city ... It generates a kind of Dahäl sphere, I must destroy it before it fully charges its full power.","color":"aqua","bold":false}]}
