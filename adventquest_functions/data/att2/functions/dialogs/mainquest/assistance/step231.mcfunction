...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I managed to reach an infirmary and it really doesn't smell good. I have to leave this place very quickly ...","color":"aqua","bold":false}]}
