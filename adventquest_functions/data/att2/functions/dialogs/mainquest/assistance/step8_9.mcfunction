...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Finally, there is something concrete: a space germ would be found in the temple of the Worlëst forest. Wirth told me it's at the other end of the forest northeast of Ryliath. However, a barbarian camp has set up in front of it, I will have to sneak in discreetly.","color":"aqua","bold":false}]}
