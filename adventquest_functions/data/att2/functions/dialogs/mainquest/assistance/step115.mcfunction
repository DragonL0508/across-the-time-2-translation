...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"This necromancer, Vonaheim, can no longer back down ... Let's face him !","color":"aqua","bold":false}]}
