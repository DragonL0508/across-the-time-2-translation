...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I arrived in the Owsästr marshes and there should be some kind of large structure attached to the mountain and emerging from the stagnant waters.","color":"aqua","bold":false}]}
