...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"Fatally and despite this warning, the medium's premonition was realized. During his final attempt to prevent this misfortune, Azazel chose to unravel this mystery with the help of Flamme Noire, Gabrielle his wife and myself.","color":"dark_aqua"}]}
