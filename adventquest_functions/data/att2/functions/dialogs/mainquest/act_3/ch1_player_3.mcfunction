...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"You know very well why I'm here. My days are numbered now. Corruption has taken over me, and it's your fault. I have to finish you off.","color":"aqua"}]}
