...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"So I have to go back to my time and face it. Will the gems in the temple allow me to return?","color":"aqua"}]}
