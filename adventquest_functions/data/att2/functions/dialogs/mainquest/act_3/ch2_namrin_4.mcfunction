...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"I almost forgot! Hey, you, the mortal who looks completely lost! What happened here? What are you doing here?","color":"dark_aqua"}]}
