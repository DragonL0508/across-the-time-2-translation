...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"We, Eternäns, would not have been able to comply with the will of this monster: Angband could not be ruled by a being of chaos, even if he was our ally for so long; by this disagreement came clashes between Eternäns and mortals.","color":"dark_aqua"}]}
