...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"How about that?! I am delighted to meet you! ''She'' brought you here, didn't she?","color":"dark_aqua"}]}
