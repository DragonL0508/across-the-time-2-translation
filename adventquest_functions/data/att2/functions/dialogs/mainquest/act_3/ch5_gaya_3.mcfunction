...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Gaya : ","color":"dark_green","extra":[{"text":"Yes, I can do that. Relgon will come back one day, and in my world. However, then it will not be the same as the one you have known. He won't know who he is...","color":"dark_aqua"}]}
