...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Sérile : ","color":"yellow","extra":[{"text":"*Anger, disappointed* HOW DO YOU DARE TO DO THIS TO ME, SERILE, SINGLE HERITAGE OF AZAZEL, ORIGINAL KING FROM ANGBAND!","color":"dark_aqua","italic":true}]}
