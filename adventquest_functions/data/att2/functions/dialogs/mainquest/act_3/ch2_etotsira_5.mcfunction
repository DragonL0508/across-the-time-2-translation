...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"dark_blue","extra":[{"text":"*Voice in the head* Yes, you are! Don't lose this opportunity to gain their trust!","italic":true,"color":"blue"}]}
