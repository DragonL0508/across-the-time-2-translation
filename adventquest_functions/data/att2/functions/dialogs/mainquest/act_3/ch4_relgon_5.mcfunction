...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"The decision was not an easy one, and I knew how much it could affect you. Namrïn will be the next king....","color":"dark_aqua"}]}
