...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Hello Etotsira.... I don't know. So much has happened: the fall of a demigod, the betrayal of Sérile, the death of Relgon and the appearance of Gaya...","color":"aqua"}]}
