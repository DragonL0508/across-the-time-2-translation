...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The two seals are now in place. It's time for me to go back to Relgon.","color":"aqua"}]}
