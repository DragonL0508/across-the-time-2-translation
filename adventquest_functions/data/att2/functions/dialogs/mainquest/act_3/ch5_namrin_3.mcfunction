...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"I think we'll have to face La Flamme Noire alone. Relgon trust me, and I hope I don't disappoint him...","color":"dark_aqua"}]}
