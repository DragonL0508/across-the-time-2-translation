...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"Unfortunately, the devastating entity did not satisfy its destructive madness after the annihilation of Angor. It also caused chaos in all the regions of the Angor globul and in the neighbouring globuls...","color":"dark_aqua"}]}
