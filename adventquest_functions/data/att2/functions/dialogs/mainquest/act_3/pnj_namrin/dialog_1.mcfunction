...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"Sérile and I trained a lot during our youth, in fact, that's all we did... Getting true control of Dahäl is not easy.","color":"dark_aqua"}]}
