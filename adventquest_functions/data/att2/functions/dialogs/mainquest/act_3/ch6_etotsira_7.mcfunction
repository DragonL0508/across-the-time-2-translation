...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"Precisely. Besides, Namrïn's murder is already your fault. Remember when you went to Desolation: Namégot, it was him.","color":"dark_aqua"}]}
