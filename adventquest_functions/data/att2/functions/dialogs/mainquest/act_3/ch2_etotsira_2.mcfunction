...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"dark_blue","extra":[{"text":"*Voice in my head* Don't talk about me, don't disturb my double from the past.","italic":true,"color":"blue"}]}
