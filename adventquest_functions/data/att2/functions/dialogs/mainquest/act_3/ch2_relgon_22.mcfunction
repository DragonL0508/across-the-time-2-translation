...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"By the loss of his wife and the destruction of his people, my brother Azazel lost his mind and disappeared, leaving his duty and Sérile, his young daughter, behind him.","color":"dark_aqua"}]}
