...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"I cannot bring back the dead, especially since he no longer had the will to live...","color":"dark_aqua"}]}
