...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"While everything was going very badly, I went into the fortress of our devastated city and condemned the entrance leading to its lair with two seals: one with the symbol of fire and the other of lava.","color":"dark_aqua"}]}
