...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"... as a strategic area, we can hardly afford to leave it in the hands of the enemy.","color":"dark_aqua"}]}
