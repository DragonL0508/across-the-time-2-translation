...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"An interdimensional portal? Unbelievable! This is the first time I've seen one!","color":"dark_aqua"}]}
