...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"Do you know that the Eternäns are immortal and invulnerable as long as they have the will to live? It is fortunate for Sérile that he no longer possessed this strength at the time of his murder.","color":"dark_aqua"}]}
