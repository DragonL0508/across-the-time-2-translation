...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"My brothers and sisters, here we are finally at the fateful moment that will once again determine the future of our kingdom. Be strong, you will need it...","color":"dark_aqua"}]}
