...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"Well, follow me, we're not safe here, and then... I don't really give you much choice.","color":"dark_aqua"}]}
