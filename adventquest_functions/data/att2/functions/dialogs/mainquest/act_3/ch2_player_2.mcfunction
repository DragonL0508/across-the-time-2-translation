...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":" ...Relgon !? ... .. Um, sorry, I mean ","color":"aqua"},{"selector":"@a[scores={NUMEROJOUEUR=1}]"},{"text":" and I just came from Tellurön.","color":"aqua"}]}
