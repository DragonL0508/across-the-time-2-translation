...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"It doesn't seem to be working. There should be something around here that can revive this system....","color":"aqua"}]}
