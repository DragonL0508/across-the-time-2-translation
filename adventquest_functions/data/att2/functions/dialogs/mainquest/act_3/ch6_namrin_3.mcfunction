...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"I mean, with these events, I forgot to thank you for it. Because none of this would have been possible without you.","color":"dark_aqua"}]}
