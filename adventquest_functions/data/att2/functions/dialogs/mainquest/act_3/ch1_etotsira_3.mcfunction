...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"... I'm disappointed that you were able to give in to despair. Or maybe you were manipulated?","color":"dark_aqua"}]}
