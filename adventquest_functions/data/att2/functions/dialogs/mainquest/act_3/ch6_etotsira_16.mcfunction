...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"Not necessarily, the Ryliath portal can also work with time gems. But if you have any questions or doubts, I'll wait here to enlighten you.","color":"dark_aqua"}]}
