...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"Rather than explanations, I can show you. But you're gonna have to trust me.","color":"dark_aqua"}]}
