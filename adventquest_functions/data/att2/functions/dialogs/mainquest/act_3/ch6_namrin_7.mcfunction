...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"I won't hold back, because the whole kingdom of Angband owes you. Know that you will always be welcome...","color":"dark_aqua"}]}
