...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"In an incessant confrontation that caused countless casualties on both sides.","color":"dark_aqua"}]}
