...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"What a pity, however, that Sérile is not among us... Do you know where she is?","color":"dark_aqua"}]}
