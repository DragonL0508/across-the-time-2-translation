...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"No, don't say that, Relgon. You have to trust me, if another one has been sent, it means you'll need it. ''Her'' will is benevolent...","color":"dark_aqua"}]}
