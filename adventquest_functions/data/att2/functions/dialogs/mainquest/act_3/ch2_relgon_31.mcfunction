...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"In addition, the training of Namrïn and Sérile was recently completed. Now that they have S capabilities, they are an asset to our forces.","color":"dark_aqua"}]}
