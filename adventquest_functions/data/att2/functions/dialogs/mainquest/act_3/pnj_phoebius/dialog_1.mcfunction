...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Phoebius : ","color":"green","extra":[{"text":"I don't know how you became aware of this artifact, but I'm not quick to entrust it to just anyone....","color":"dark_aqua"}]}
