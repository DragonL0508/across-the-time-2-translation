...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The Phoenix village is on my left, I should go there first to get the seal before going to Angor, it will save me time...","color":"aqua"}]}
