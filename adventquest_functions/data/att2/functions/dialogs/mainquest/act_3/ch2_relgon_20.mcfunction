...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"It did not end there. In a single hour, she ruined the city of Angor, spitting out its black fire everywhere, which never went out. A large part of the Eternän people died that day.","color":"dark_aqua"}]}
