...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"Thank you. Then we'll be waiting for you. Come back to me when you feel ready.","color":"dark_aqua"}]}
