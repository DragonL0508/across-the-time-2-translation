...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"There are many things you don't know. And that's why between the two of us, I'm the one called wise. But it is not with this title that I will fight you: prepare to face a demi-god.","color":"dark_aqua"}]}
