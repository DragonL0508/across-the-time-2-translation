...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"...He recognized me as a ''friend'' when I defeated him, that's why... But how did he turn into such a monster? Yet he seemed calm, thoughtful and sensitive by nature...","color":"aqua"}]}
