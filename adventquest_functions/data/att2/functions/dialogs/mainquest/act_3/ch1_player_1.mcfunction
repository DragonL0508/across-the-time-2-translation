...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"That's it! That's it! The Ryliath space portal is activated! I'm finally going to be able to put an end to Etotsira and this curse!","color":"aqua"}]}
