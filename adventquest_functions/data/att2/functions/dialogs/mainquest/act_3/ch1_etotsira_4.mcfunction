...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Etotsira : ","color":"blue","extra":[{"text":"That's what I was afraid of. Since you won't want to hear any of my explanations, and I won't let you kill me, we both know the outcome of this conversation.","color":"dark_aqua"}]}
