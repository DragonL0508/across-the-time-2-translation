...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"There, I wanted to give you a present. I noticed that you use the Dahäl in a very special way. You need a book I think, so I've experimented using the power of the source and I think I've come up with a result that will interest you:","color":"dark_aqua"}]}
