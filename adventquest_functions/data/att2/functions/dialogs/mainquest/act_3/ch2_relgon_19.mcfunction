...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Relgon : ","color":"red","extra":[{"text":"In our surprise and misunderstanding,''La Flamme Noire'' took the life of the medium as well as that of Gabrielle...","color":"dark_aqua"}]}
