...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"Corruption? It's a pretty dark name, but it's also intriguing! Then it will be 'corruption'!","color":"dark_aqua"}]}
