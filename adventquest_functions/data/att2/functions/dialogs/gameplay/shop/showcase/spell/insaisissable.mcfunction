...
tellraw @a[scores={LANGUAGE=2}] {"text":" ° ","bold":true,"color":"dark_red","extra":[{"text":"<Elusive>","bold":false,"color":"dark_green","hoverEvent":{"action":"show_text","value":"Dissolves your physical body in ether. Your movement and attack speed increases but you will be very hungry."},"extra":[{"text":" [250 Chronotons]","color":"yellow","clickEvent":{"action":"run_command","value":"/execute positioned as @e[tag=TRADER,distance=..7] at @s run function att2:gameplay/shop/purchase/spell/insaisissable"},"hoverEvent":{"action":"show_text","value":"Click here to buy!"}}]}]}
