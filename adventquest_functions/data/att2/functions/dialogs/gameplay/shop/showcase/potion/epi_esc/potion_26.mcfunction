...
tellraw @a[scores={LANGUAGE=2}] {"text":" ° ","bold":true,"color":"dark_red","extra":[{"text":"<Rempart>","bold":false,"color":"light_purple","hoverEvent":{"action":"show_item","value":"{\"id\":\"minecraft:potion\",\"Count\":1,\"tag\":{\"display\":{\"Name\":\"{\\\"text\\\":\\\"§dRempart\\\"}\",\"Lore\":[\"{\\\"text\\\":\\\"§7Faites de votre peau votre armure.\\\"}\",\"{\\\"text\\\":\\\"§7Make your skin your armor.\\\"}\",\"{\\\"text\\\":\\\"§7抗§a1 §7速度§c-4\\\"}\"]},\"CustomPotionColor\":11642273}}"},"extra":[{"text":" [1 ESC]","color":"light_purple","clickEvent":{"action":"run_command","value":"/execute positioned as @e[tag=TRADER,distance=..7] at @s run function att2:gameplay/shop/purchase/potion/epi_esc/potion_26"},"hoverEvent":{"action":"show_text","value":"Click here to buy!"}}]}]}
