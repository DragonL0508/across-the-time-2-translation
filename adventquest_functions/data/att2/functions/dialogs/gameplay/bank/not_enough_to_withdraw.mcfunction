...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Gaelle : ","color":"green","extra":[{"text":"Sorry, but you don't have enought chronoton on your account to withdraw that amount...","color":"gold"}]}
