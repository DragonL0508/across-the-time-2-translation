...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@s","color":"dark_red","extra":[{"text":" : "},{"text":"I need a ","color":"aqua","extra":[{"text":"<Big Key>","color":"gray","hoverEvent":{"action":"show_item","value":"{\"id\":\"minecraft:nether_brick\",\"Count\":1,\"tag\":{\"display\":{\"Name\":\"{\\\"text\\\":\\\"§eGrande Clef\\\"}\",\"Lore\":[\"{\\\"text\\\":\\\"§4Big Key\\\"}\"]}}}"},"extra":[{"text":" to open this door!","color":"aqua"}]}]}]}
