...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"Good thing J'zargo was there, otherwise the ignorant would have been chopped to the smallest bits...","color":"dark_aqua"}]}
