...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"J'zargo does not need to fumble here any longer. He leaves for the southern limits of the Owsästr swamps.","color":"dark_aqua"}]}
