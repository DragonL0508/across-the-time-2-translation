...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"''The most primordial of knowledges is engraved on the ultimate remain of what they were.'', this must be the object that J'zargo is looking for.","color":"aqua"}]}
