...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"Help? J'zargo needs no one, and especially not some ignorant. Oh, but J'zargo's getting it, the idiot is looking for someone to teach him things.","color":"dark_aqua"}]}
