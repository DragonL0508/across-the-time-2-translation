...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Go ahead, I will find you there, *in a hushed voice* if my day is shining, if I find an orange weapon and if I suddenly miss getting treated like shit.","color":"aqua"}]}
