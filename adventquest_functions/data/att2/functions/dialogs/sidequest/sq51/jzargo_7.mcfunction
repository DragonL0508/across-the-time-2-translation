...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"J'zargo will stay here to search. The pupil will go deeper to find more clues...","color":"dark_aqua"}]}
