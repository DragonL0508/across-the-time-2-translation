...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"A huge key! Jack was right, i must now reach the secret island on south of Asunark and sneak in these pirate's lair.","color":"aqua"}]}
