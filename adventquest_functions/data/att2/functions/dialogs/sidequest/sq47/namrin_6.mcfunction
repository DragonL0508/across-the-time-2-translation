...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"Here is the cemetery of Irilion. The greatest sanctuary to ever be, since it is the place itself where Angbang's divine creator disappeared, a hunded of thousand cycles ago, under the violence of Môt's actions.","color":"dark_aqua"}]}
