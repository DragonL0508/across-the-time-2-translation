...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"He explained to me that it was the very place he forged the sword Rukyrion : ''divine blood''. It is a legendary sword that only him could wield without being injured by it's aura. I hid it here after he pased away.","color":"dark_aqua"}]}
