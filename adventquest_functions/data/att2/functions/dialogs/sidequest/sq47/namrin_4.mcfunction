...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"Of course, only Relgon was able to defeat the ultimate error! The kingdom of Angband saw his near death that day...","color":"dark_aqua"}]}
