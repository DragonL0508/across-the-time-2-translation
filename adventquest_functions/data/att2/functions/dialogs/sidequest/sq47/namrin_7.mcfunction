...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"Relgon had showed me this place to convince me of Irilion's existence, since I am way too young to have met him...","color":"dark_aqua"}]}
