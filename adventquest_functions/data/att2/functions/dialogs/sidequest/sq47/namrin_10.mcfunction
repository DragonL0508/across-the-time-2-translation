...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"Forgive me for not having faith in you. So you really are Relgon's reincarnation... It's astonishing.","color":"dark_aqua"}]}
