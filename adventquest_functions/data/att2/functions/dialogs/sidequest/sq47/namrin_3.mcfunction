...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"These inscriptions! It's the crown! The ultimate error's crown! ","color":"dark_aqua"},{"selector":"@a[scores={NUMEROJOUEUR=1}]"},{"text":", you found the ultimate error's crown! This artifact is amongst the most horrendous created by Môt! It's also the reason behind the Angband war and of many others after!","color":"dark_aqua"}]}
