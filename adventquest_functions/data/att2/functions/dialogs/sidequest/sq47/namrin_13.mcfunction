...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"I hid the error's crown somewhere nobody will find it. Thank you again for your help, my friend:","color":"dark_aqua"}]}
