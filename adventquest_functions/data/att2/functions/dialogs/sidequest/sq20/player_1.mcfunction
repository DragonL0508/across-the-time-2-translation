...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"It's the wall of the bank vault... I have to wait for the night to knock it over...","color":"aqua"}]}
