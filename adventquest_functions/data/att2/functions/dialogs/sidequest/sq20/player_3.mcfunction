...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"This is the wall that Chiara told me about. It is indeed well damaged, a single blow will cause it to fall. Hope no one hears...","color":"aqua"}]}
