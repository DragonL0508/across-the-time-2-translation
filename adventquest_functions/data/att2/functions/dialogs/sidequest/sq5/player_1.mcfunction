...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Here are our culprits... But... It is a litter of puppies with ... their mother ... I begin to understand why Mia ran away...","color":"aqua"}]}
