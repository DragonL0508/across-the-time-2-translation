...
tellraw @a[scores={LANGUAGE=2}] {"text":"-°- An uncontrollable invasion -°- : ","color":"gray","extra":[{"text":"I have to kill about twenty slimes in the Mine of the Phoenix village and go back to Gary to receive my reward","color":"aqua","italic":true}]}
