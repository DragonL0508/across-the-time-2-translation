...
tellraw @a[scores={LANGUAGE=2}] {"text":"-°- J'zargo's legendary quest - Part 6 -°- : ","color":"gray","extra":[{"text":"That's it, let's now talk to Triss to hope for some reward for this misadventure.","color":"aqua","italic":true}]}
