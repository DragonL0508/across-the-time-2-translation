...
tellraw @a[scores={LANGUAGE=2}] {"text":"-°- Memories from outer-time -°- : ","color":"gray","extra":[{"text":"I finally have the weapon ''Nekr al Felèvsil''! I must bring it back to Aldelrion in Angor.","color":"aqua","italic":true}]}
