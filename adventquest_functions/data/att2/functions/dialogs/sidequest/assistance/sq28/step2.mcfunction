...
tellraw @a[scores={LANGUAGE=2}] {"text":"-°- The End of a Journey -°- : ","color":"gray","extra":[{"text":"Korlaph is crazy, I have to get rid of him. He is located in the temple of Elcheol ...","color":"aqua","italic":true}]}
