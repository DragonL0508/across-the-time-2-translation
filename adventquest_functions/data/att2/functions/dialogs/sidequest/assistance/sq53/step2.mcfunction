...
tellraw @a[scores={LANGUAGE=2}] {"text":"-°- J'zargo's legendary quest - Part 3 -°- : ","color":"gray","extra":[{"text":"Luckily I'm here... Well, I have to find one more item J'zargo covets in these places far from Billgart.","color":"aqua","italic":true}]}
