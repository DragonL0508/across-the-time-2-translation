...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Lary Brett : ","color":"green","extra":[{"text":"So you cleaned the entrance to the catacombs? No? I will not open it as long as there are all these undead running around...","color":"dark_aqua"}]}
