...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"There was a sorcerer, furious against a certain female thief. It was probably your daughter...","color":"aqua"}]}
