...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"It is done! This Myrath spoke of a thief, it is surely the person Emerald is looking for. Let's take the rest of the contents of the chest and report the news to him.","color":"aqua"}]}
