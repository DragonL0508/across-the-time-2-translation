...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I think I've killed enough, the entrance should be safe for Lary. I must return to see him to announce it.","color":"aqua"}]}
