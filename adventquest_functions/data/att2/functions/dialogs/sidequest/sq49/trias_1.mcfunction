...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Trias : ","color":"green","extra":[{"text":"I shall return to my own world now that my bow came back to me. May the fate be with you, traveler.","color":"dark_aqua"}]}
