...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Trias : ","color":"green","extra":[{"text":"*worried* I lost way too much time in Ouranos. The news you are sharing me are terrible! I urgently need to return to mu world!","color":"dark_aqua"}]}
