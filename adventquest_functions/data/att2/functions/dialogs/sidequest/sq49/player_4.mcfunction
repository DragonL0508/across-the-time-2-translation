...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"My name is ","color":"aqua"},{"selector":"@a[scores={NUMEROJOUEUR=1}]"},{"text":", but they call me hero in Tellurön.","color":"aqua"}]}
