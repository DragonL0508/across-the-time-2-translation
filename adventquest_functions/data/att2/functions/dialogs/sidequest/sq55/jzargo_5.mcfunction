...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"Now that is done. J'zargo is cold, he will continue his studies lower in the mountain. Now, the pupil gets along without him.","color":"dark_aqua"}]}
