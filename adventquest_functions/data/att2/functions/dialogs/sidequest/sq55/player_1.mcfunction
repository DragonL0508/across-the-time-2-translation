...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"J'zargo... I don't know which force prevented me to break every single finger of yours, to slice your ankles and to leave you agonizing in a chasm...","color":"aqua"}]}
