...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"Now? This does not concern the student, but it will soon understand anyway... Farewell!","color":"dark_aqua"}]}
