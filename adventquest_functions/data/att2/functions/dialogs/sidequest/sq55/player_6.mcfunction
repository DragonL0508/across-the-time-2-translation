...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"He must have returned to the Dahäl academy. I hope he's gonna do a huge mistake: I can't wait to punch his face!","color":"aqua"}]}
