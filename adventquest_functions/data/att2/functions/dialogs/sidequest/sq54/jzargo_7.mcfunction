...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"No, J'zargo is not done with his researches! And if the ignorant pupil does not change his mood, J'zargo will not teach anything anymore.","color":"dark_aqua"}]}
