...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"*weary* So J'zargo, what is the magic sentence or the sort of riddle for the next thing you came to fetch?","color":"aqua"}]}
