...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"*weary* Awesome, okay now open the door so that I slaughter the creature on the other side and bring you his treasure.","color":"aqua"}]}
