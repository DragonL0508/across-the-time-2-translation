...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"The pupil came, once again. J'zargo would have liked for him to be stuck in Billgart, bue the pupil is too lucky and loves disrupting his master so much. ","color":"dark_aqua"}]}
