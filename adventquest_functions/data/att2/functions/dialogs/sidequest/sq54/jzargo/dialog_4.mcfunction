...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Just curious, how do you intend to make the disrespectfuls pay?","color":"aqua"}]}
