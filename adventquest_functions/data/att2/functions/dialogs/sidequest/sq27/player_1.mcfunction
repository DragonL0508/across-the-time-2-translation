...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"If Emerald's daughter has been here, I should find some ancient remains in the cave.","color":"aqua"}]}
