...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Your daughter doesn't appreciate being followed. And she likes explosive surprises...","color":"aqua"}]}
