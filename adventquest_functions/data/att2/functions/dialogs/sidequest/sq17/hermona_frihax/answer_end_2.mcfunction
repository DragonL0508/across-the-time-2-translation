...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Hermona : ","color":"green","extra":[{"text":"Great and just in time! Do you have the quota? I was able to raise a small sum of money to reward your courage. Thanks again...","color":"dark_aqua"}]}
