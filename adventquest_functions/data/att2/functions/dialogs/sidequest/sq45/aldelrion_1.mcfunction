...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Aldelrion : ","color":"green","extra":[{"text":"I saw a number of wars during my lifetime... But rare are those which carry their aches to the depths of our souls.","color":"dark_aqua"}]}
