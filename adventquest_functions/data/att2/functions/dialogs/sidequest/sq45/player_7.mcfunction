...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"''Nekr al Felèvsil'', it's the weapon that Aldelrion searched for. Maybe I should bring it to him...","color":"aqua"}]}
