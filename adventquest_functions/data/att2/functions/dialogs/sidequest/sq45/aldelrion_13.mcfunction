...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Aldelrion : ","color":"green","extra":[{"text":"Take this badge as well. I found it in the rubble just before you came back. It must have belonged to a small group in the region, I'll let you discover its usefulness, I don't need it...","color":"dark_aqua"}]}
