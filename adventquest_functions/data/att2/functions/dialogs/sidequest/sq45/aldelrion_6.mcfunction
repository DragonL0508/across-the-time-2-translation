...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Aldelrion : ","color":"green","extra":[{"text":"For my house, no, not really. But since you are proposing yourself, I have a request for you.","color":"dark_aqua"}]}
