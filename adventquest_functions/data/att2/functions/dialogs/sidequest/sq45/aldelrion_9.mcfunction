...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Aldelrion : ","color":"green","extra":[{"text":"May ask you a question now? I don't think that you went through the worlds and braved war by mere kindness. You were searching for something, were you not? But for what?","color":"dark_aqua"}]}
