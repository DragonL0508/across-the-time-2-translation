...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Delivering things, I already make enough deliveries with my job... -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-030a-0000-00000000030a if entity @s[distance=..7] if score sigfrid_barkon_PNJ DIALOG matches 2..3 run function att2:cinematic/sidequest/8/sigfrid_barkon/answer_2_1"},"hoverEvent":{"action":"show_text","value":"Click here - answer 2"}}]}
