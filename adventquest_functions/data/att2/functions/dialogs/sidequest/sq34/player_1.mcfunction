...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Blood and an abandoned shipment of stones. Something has happened, let's go see in this cave...","color":"aqua"}]}
