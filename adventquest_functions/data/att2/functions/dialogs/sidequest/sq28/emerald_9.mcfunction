...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Emerald : ","color":"green","extra":[{"text":"Thank you for your precious help. We will rest before going home to Eanrdhel.","color":"dark_aqua"}]}
