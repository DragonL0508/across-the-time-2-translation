...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"In Earndhel? I remember helping you there four years ago in the business of... hooch ... Anyway, it's in the past now. Come on, have a good trip!","color":"aqua"}]}
