...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Korlaph : ","color":"green","extra":[{"text":"I can't concentrate enough with all these people! I'm... I'm losing her! SILENCE!","color":"dark_red"}]}
