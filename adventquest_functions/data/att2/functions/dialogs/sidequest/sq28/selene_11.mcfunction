...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Sélène : ","color":"green","extra":[{"text":"You're right... I understand better why you were so sad and desperate, father. But you could have told me the truth about the loss of mom! Why did you hide everything from me?","color":"dark_green"}]}
