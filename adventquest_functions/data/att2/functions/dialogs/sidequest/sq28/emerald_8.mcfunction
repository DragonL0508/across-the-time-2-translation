...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Emerald : ","color":"green","extra":[{"text":"You were too young to understand. And... I was weak at that time... Korlaph had announced the news to me but ultimately without admitting the whole truth about the circumstances of Tatiana's death. I did not know the existence of this Lucimene... And then, Korlaph must have succumbed to this mysterious evil...","color":"dark_aqua"}]}
