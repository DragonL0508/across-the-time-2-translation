...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Sélène : ","color":"green","extra":[{"text":"Father, I never thought you would have had wanted to look for me in your state...","color":"dark_green"}]}
