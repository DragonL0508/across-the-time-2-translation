...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Sélène : ","color":"green","extra":[{"text":"What he did to mother is unforgivable and he got what he deserved, let's not talk about him anymore... But wait, I found this card during my trip... It will be more useful to you than to me. Take it as a thank you.","color":"dark_green"}]}
