...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Alfred Mornith : ","color":"green","extra":[{"text":"Hey there, are we lost? This is my family's mine, private property! Unless you want to help us with the collapse of this business, I'm going to ask you to leave.","color":"dark_aqua"}]}
