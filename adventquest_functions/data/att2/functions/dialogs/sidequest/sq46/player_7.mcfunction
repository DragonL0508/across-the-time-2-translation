...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"What is this thing! It stole the crown, that's not gonna end good! I need to stop it right now!","color":"aqua"}]}
