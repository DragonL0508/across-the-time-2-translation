...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Namrïn : ","color":"dark_purple","extra":[{"text":"Your worth is already more than acknowledged, but I am still eager to see that, my friend!","color":"dark_aqua"}]}
