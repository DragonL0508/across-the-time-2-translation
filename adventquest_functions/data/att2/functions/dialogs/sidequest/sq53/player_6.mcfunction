...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"*sarcasm* Guess what J'zargo, I bring you this stone by sheer luck so you can describe it to me and then explain how idiotic I am for not understanding it's worth...","color":"aqua"}]}
