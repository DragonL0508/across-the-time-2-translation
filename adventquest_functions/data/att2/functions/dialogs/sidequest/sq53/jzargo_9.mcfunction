...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"He must pass through the Worlëst forest in Tellurön, for an ancient power awoke there recently.","color":"dark_aqua"}]}
