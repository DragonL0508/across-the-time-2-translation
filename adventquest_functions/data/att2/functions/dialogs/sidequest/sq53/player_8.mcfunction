...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"*fakely enthusiastic* Yes, awesome, I think your journey finally comes to an end J'zargo! Maybe you should get back to the academy of Dahäl to celebrate your victory?!","color":"aqua"}]}
