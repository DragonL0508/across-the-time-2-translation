...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"I will let it go this time... But may the pupil not stand here and go somewhere else.","color":"dark_aqua"}]}
