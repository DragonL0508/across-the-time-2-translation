...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"*surprised* The pupil acts strange today, maybe is this world's atmosphere turning him ill?","color":"dark_aqua"}]}
