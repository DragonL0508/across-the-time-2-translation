...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"That's it, see you soon in that forest. I hope this ancient power won't find you before I do... *in a hushed voice* please make it happen.","color":"aqua"}]}
