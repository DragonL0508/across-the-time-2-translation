...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"To punish him, he will have to finish his master's work and clear the pathway with a fireball!","color":"dark_aqua"}]}
