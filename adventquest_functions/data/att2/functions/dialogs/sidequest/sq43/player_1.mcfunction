...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I opened a breach in the rock under the mine waterfall. Let's explore it all...","color":"aqua"}]}
