...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Sorry for this entry, I did not want to disturb you: I am following in the footsteps of a thief. I'll leave you.","color":"aqua"}]}
