...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Ithil : ","color":"green","extra":[{"text":"Are you stupid for doing this Jaris? Do you not see the mess that you caused in the palace?","color":"blue"}]}
