...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[What do you mean, you found a boot in your chimney? I'm on an urgent matter, tell me more about these secret passages. -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-098a-0000-00000000098a if entity @s[distance=..7] if score joel_roblochon_PNJ DIALOG matches 2 run function att2:cinematic/sidequest/30/joel_roblochon/answer_1_1"},"hoverEvent":{"action":"show_text","value":"Click here - answer 1"}}]}
