...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Gregor Gacko : ","color":"green","extra":[{"text":"Again thank you for the help. With my brother we will be a little more discreet in the near future...","color":"dark_aqua"}]}
