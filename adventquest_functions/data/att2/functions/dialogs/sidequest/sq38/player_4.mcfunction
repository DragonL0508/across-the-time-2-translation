...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Hmm, Walton is gone. It must be said that it was not a safe place for him...","color":"aqua"}]}
