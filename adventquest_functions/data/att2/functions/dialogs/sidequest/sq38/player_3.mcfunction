...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The artifact was placed on the altar without my will ... Back off Walton, I have a bad presentiment!","color":"aqua"}]}
