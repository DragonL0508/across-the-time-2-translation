...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"Lady Triss is so kind, and she knows she is the only one to understand me...","color":"dark_aqua"}]}
