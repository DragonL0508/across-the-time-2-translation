...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"*hushed, to himself* Why didn't I kill this lunatic at first sight... Thats what happens when you're too patient.","color":"aqua"}]}
