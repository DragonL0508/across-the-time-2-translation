...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"What?? What is the pupil doing here? J'zargo wished to never see this ignorant, noisy and stinking subhuman!","color":"dark_aqua"}]}
