...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Answer my question now... My patience has limits and I'm not in the mood for your insults.","color":"aqua"}]}
