...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Triss : ","color":"green","extra":[{"text":"It's enough J'zargo, I will only forgive you if you present honest apologies to ","color":"dark_aqua"},{"selector":"@a[scores={NUMEROJOUEUR=1}]"},{"text":" and if you cease this masquerade!","color":"dark_aqua"}]}
