...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"No, how could the pupil have done this! J'zargo should have been invincible!","color":"dark_aqua"}]}
