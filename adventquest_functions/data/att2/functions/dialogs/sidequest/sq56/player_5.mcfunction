...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"An engraved bone, a cristal tear, a strange emerald, unperishable blood and an old scroll...","color":"aqua"}]}
