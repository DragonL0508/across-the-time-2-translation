...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Triss : ","color":"green","extra":[{"text":"As long as you respect them, it would make sense. By the way, Cassandre would be very happy if you gave her locket back.","color":"dark_aqua"}]}
