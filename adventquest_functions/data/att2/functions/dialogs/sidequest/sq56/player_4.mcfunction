...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I guess, I mean, I don't know if he told you about his project but it sounds nothing like a miss world wish... I mean, it doesn't sound reassuring.","color":"aqua"}]}
