...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Triss : ","color":"green","extra":[{"text":"His project? No, I know nothing about that... What did you find during your journey?","color":"dark_aqua"}]}
