...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Triss : ","color":"green","extra":[{"text":"J'zargo received a good beating, but I think he will learn to appreciate you now.","color":"dark_aqua"}]}
