...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Triss : ","color":"green","extra":[{"text":"Those are the needed elements for an alternative invocation... J'zargo must be somewhere in the academy, and he must be found before he invokes some sinister entity!","color":"dark_aqua"}]}
