...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"J'zargo hands Cassandre's locket to the pupil, he must clean up the mess he made here.","color":"dark_aqua"}]}
