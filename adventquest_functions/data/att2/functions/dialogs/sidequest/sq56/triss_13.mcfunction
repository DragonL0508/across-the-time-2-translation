...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Triss : ","color":"green","extra":[{"text":"No J'zargo he is not evil towards you, he is reacting to your actions. I always loved you J'zargo, like my own son and since the day I took you in my care. ","color":"dark_aqua"},{"selector":"@a[scores={NUMEROJOUEUR=1}]"},{"text":"'s choice is not my decision: if he kills you, then you will have paid for your mistakes: but if he lets you live then you will have to understand the wrong you did to him and admit he has been good to you.","color":"dark_aqua"}]}
