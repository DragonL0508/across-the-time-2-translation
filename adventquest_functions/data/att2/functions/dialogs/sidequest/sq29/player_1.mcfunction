...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I finally got rid of all the bandit camps. I had better warn Ragnar in Méleïm that my mission is finished.","color":"aqua"}]}
