...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Mortimer : ","color":"green","extra":[{"text":"What? So you found a temple under a big tree? Interesting! I have to see this with my own eyes... Thanks again for everything, here is the rest of my savings, you deserve it.","color":"dark_aqua"}]}
