...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The wall is crumbly at my feet, there may be an entrance here... A fairly powerful shake should do the trick.","color":"aqua"}]}
