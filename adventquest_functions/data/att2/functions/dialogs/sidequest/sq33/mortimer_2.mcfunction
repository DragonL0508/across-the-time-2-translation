...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° Mortimer : ","color":"green","extra":[{"text":"You found them all! Thank you very much, it will greatly advance my research...","color":"dark_aqua"}]}
