...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"*to himself* Remain calm, remain calm... Think, what would Relgon have done... Actually i'm pretty sure he would have been capable of slicing him in half vertically, but he would have remained calm.","color":"aqua"}]}
