...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"It is but one of J'zargo's many skills. The pupil might know some day, but for now it stays stupid and stinky.","color":"dark_aqua"}]}
