...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Eeeeh, now that's impressive I must admit... The vast majority of people seem to be unaware of what a kingdom is and even more of whithin which they live.","color":"aqua"}]}
