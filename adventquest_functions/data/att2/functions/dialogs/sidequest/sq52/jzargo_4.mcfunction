...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"Over this gigantic stone barrier hides a white sand desert. Where no rain ever falls are hidden old structures. ''For whom loses hope at the confines of meere solitude, the very fruit of his sorrow he misses''.","color":"dark_aqua"}]}
