...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Yeah... I see.. I guess you have an idea about how to attain Billgart?","color":"aqua"}]}
