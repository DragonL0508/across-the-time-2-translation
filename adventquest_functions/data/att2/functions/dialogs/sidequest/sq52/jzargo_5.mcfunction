...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"An old passageway leads to this desert, and J'zargo knows how to open it, because he is not so ignorant as the pupil.","color":"dark_aqua"}]}
