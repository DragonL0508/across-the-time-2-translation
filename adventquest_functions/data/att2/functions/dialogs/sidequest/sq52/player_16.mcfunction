...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"So be it. I will join you there. *to himself, hushing* I will have to keep an eye on him, who knows what he is thinking about...","color":"aqua"}]}
