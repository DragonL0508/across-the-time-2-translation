...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I have to admit you do have a talent J'zargo, you can successfully open doors. ","color":"aqua"}]}
