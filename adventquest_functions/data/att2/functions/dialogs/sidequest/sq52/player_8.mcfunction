...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Did you happen to fall on your head often as a child, or were you just raised by a polecat?","color":"aqua"}]}
