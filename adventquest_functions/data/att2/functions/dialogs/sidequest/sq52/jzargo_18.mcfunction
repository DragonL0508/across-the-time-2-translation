...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"Yes, J'zargo knows and he is tired of hearing the pupil ask questions. He leaves for Billgart, close to a gicangic structure filled with secrets. But it is not it's objective, for the most grands of secrets are not confined in such visible things.","color":"dark_aqua"}]}
