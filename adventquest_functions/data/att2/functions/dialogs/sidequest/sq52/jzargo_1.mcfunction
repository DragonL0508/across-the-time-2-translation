...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"Wha is J'zargo seeing? It is the idiotic pupil he met in Kert. J'zargo smelt it come from afar, since its stink covers up the swamp's own.","color":"dark_aqua"}]}
