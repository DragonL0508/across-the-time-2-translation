...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"J'zargo is not an ignorant, he knows lots of things. And everyone despise him without reason. But J'zargo will show them...","color":"dark_aqua"}]}
