...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"J'zargo does not wish to be disturbed... Oh, but what's that the sutdent is carrying?","color":"dark_aqua"}]}
