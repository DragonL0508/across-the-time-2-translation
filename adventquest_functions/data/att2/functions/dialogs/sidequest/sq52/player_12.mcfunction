...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"This item is magnificent, it has the shape of a teardrop. What was J'zargo saying already: ''For whom loses hope at the confines of meere solitude, the very fruit of his sorrow he misses''. Yes, that must be what he is searching for. Let's hope he'll be content with it and get back to the academy...","color":"aqua"}]}
