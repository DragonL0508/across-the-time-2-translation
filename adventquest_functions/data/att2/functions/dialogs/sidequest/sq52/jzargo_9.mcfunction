...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° J'zargo : ","color":"green","extra":[{"text":"The pupil is impatient, but for which purpose? J'zargo doubts it remembers the reason of our coming here...","color":"dark_aqua"}]}
