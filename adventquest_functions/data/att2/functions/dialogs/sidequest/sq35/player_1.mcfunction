...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Here, these bandits will no longer come back to the area. Let's go back to Nestor to tell him the news.","color":"aqua"}]}
