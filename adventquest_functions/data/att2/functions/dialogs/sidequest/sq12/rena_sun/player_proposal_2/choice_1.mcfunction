...
tellraw @a[scores={LANGUAGE=2}] {"text":" °-° : ","color":"dark_gray","extra":[{"text":"Let's see... [move the stone block].","color":"gray","clickEvent":{"action":"run_command","value":"/scoreboard players set choice SQ12 1"},"hoverEvent":{"action":"show_text","value":"Click here - answer 1"}}]}
