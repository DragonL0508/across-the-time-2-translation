...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[But of course, after all, I have nothing to do with going out to paddle in the droppings of a town populated by lousy, incapable people. -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-032a-0000-00000000032a if entity @s[distance=..7] if score hurriel_sun_PNJ DIALOG matches 2..3 run function att2:cinematic/sidequest/6/hurriel_sun/answer_3_1"},"hoverEvent":{"action":"show_text","value":"Click here - answer 3"}}]}
