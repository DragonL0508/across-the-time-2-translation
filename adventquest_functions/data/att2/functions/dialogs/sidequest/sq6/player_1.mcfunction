...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"I have your keys, you can thank Berni for letting me enter the sewers.","color":"aqua"}]}
