...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Hey, I found the culprit of poisoning your horses: it was Elisa, your sister... She seems to be very angry with you.","color":"aqua"}]}
