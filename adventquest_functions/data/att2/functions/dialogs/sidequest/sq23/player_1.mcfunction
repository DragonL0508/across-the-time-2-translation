...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Here I have killed enough, these filth should not reproduce any more... I will return to see Philipo to announce the good news to him.","color":"aqua"}]}
