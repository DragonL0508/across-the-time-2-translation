...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"It looks like it is used to operate the mine elevator. Surely there is a shortage of coal to restart it. A dozen should be more than enough.","color":"aqua"}]}
