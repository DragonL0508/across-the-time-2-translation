...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","extra":[{"text":" : "},{"text":"[Yes, of course where can I find this ore? -->]","color":"gray","clickEvent":{"action":"run_command","value":"/execute at 00000000-0000-026a-0000-00000000026a if entity @s[distance=..7] if score wulk_PNJ DIALOG matches 1..2 run function att2:cinematic/sidequest/2/wulk/answer_1_1"},"hoverEvent":{"action":"show_text","value":"Click here - answer 1"}}]}
