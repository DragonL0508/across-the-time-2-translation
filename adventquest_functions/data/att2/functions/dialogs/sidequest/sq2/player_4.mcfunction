...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"The dam is open! The small underground lake has partially emptied of its water, I can finally reach the room which was blocked.","color":"aqua"}]}
