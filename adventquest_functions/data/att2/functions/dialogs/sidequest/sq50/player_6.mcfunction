...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"Hello, an apprentice complained about grievance from J'zargo. I would like to inquire with him, and I heard you knew where he is...","color":"aqua"}]}
