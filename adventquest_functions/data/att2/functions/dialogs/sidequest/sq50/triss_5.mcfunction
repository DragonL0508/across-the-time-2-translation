...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Triss : ","color":"green","extra":[{"text":"No, find him and assist him until he gets what he is searching for, or eventually gives up...","color":"dark_aqua"}]}
