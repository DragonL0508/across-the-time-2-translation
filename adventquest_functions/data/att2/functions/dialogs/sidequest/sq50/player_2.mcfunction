...
tellraw @a[scores={LANGUAGE=2}] {"selector":"@a[scores={NUMEROJOUEUR=1}]","color":"dark_red","extra":[{"text":" : "},{"text":"You hid very well little rascal... Now let's bring you back to your owner.","color":"aqua"}]}
