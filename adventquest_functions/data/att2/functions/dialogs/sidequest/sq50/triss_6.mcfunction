...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Triss : ","color":"green","extra":[{"text":"He must be in the Kert desert right now. Be patient with him, even if he seems obnoxious, you will help him a lot. But be really careful not to say it's me that is sending you!","color":"dark_aqua"}]}
