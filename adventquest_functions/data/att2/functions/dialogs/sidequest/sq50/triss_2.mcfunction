...
tellraw @a[scores={LANGUAGE=2}] {"text":"°-° Triss : ","color":"green","extra":[{"text":"J'zargo is not a fun guy, he has the reputation of being a little thug among the pupils. We can't blame it all on him: he did not have an easy childhood. It was eight years ago that I lend him my hand, when I was still nothing but an apprentice of Dahäl, and now I would like for him to find a place among us. His vocation is most likely not meant to be Master of Dahäl, but this scholarship is all I can offer him, and I am sure a bit of recognition will make him feel better.","color":"dark_aqua"}]}
